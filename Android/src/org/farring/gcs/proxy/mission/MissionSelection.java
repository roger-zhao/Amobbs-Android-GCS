...
public class MissionSelection {
     ...
     *
     * @param item mission item render to remove from the selected list
     */
    ...
    /**
     * Selects only the given mission items renders. TODO: check the mission items renders belong to this mission render
     *
    ...
    /**
     * Selects only the given mission item render. TODO: check the mission item render belongs to this mission render
     *
    ...
    /**
     * Adds the given mission item render to the selected list. TODO: check the mission item render belongs to this mission render
     *
    ...
    /**
     * Selects the given list of mission items renders TODO: check if the given mission items renders belong to this mission render
     *
     * @param items list of mission items renders to select.
     */
