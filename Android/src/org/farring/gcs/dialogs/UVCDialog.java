...
public class UVCDialog extends DialogFragment {
    ...
    private final OnClickListener mOnDialogClickListener = new OnClickListener() {
        @Override
    ...
    private static final class DeviceListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            ...
            if (convertView instanceof CheckedTextView) {
                ...
                ((CheckedTextView) convertView).setText(String.format("(%x:%x:%s)", device.getVendorId(), device.getProductId(), device.getDeviceName()));
            }
            return convertView;
        }
    }
