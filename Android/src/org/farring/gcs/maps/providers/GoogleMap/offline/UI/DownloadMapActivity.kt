...
//import org.jelsoon.android.maps.providers.GoogleMap.offline.Downloader.MapDownloader.OfflineMapDownloaderState.RUNNING
//import org.jelsoon.android.maps.providers.GoogleMap.offline.Downloader.MapDownloaderListener
...
//                    runOnUiThread {
//                        Toast.makeText(applicationContext, "Invalid mapbox credentials! Cancelling map download...", Toast.LENGTH_LONG).show()
//                        cancelMapDownload()
//                    }
//                }
//            }
...
//        }
//
//        if (mapDownloader.state == RUNNING) {
//            enableDownloadInstructions(false)
...
//        mapDownloader.beginDownloadingMap(mapArea, 0, MAP_CACHE_ZOOM_LEVEL)
//    }
//
