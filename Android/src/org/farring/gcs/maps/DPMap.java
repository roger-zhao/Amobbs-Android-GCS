...
public interface DPMap {
    ...
    String EXTRA_MAX_FLIGHT_PATH_SIZE = PACKAGE_NAME + "" + ".EXTRA_MAX_FLIGHT_PATH_SIZE";

    int FLIGHT_PATH_DEFAULT_COLOR = 0xfffd693f;
    int FLIGHT_PATH_DEFAULT_WIDTH = 8;

    int MISSION_PATH_DEFAULT_COLOR = Color.WHITE;
    int MISSION_PATH_DEFAULT_WIDTH = 8;

    int DRONE_LEASH_DEFAULT_COLOR = Color.WHITE;
    int DRONE_LEASH_DEFAULT_WIDTH = 2;

    int POLYGONS_PATH_DEFAULT_COLOR = Color.RED;
    int POLYGONS_PATH_DEFAULT_WIDTH = 8;

    // 广东省广州市天河区棠下街道西北方向[广东省广州市天河区棠安苑]
    String PREF_LAT = "pref_map_lat";
    float DEFAULT_LATITUDE = 23.1340940000f;

    String PREF_LNG = "pref_map_lng";
    float DEFAULT_LONGITUDE = 113.3754650000f;
     ...
     *
     * @param listener The callback that's invoked when the map is tapped. To unset
     ...
     *
     * @param listener The callback that's invoked when the map is long pressed. To
     ...
     *
     * @param listener The callback that's invoked when a marker is clicked. To unset
     *                 the callback, use null.
     */
     ...
     *
     * @param listener The callback that's invoked on marker drag events. To unset
     *                 the callback, use null.
     */
