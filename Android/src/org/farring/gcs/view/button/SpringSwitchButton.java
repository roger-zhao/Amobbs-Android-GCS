package org.farring.gcs.view.button;
...
public class SpringSwitchButton extends View implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public SpringSwitchButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpringSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
