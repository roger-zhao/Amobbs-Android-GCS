...
class DrawToolsImpl extends EditorToolsImpl implements AdapterView.OnItemSelectedListener {
    ...
    private MissionItemType selectedType = DRAW_ITEMS_TYPE[2];
    ...
    void onRestoreInstanceState(Bundle savedState) {
        ...
        final String selectedTypeName = savedState.getString(EXTRA_SELECTED_DRAW_MISSION_ITEM_TYPE, DRAW_ITEMS_TYPE[2].name());
