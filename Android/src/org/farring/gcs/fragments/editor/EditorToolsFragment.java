...
import org.farring.gcs.view.button.RadioButtonCenter;

/**
 * This fragment implements and displays the 'tools' used in the editor window to switch between different type of waypoints creation.
 */
public class EditorToolsFragment extends BaseFragment implements OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final AdapterMissionItems drawItemsAdapter = new AdapterMissionItems(context, R.layout.spinner_drop_down_mission_item, DrawToolsImpl.DRAW_ITEMS_TYPE);
    ...
    public EditorToolsImpl getDrawToolsImpl() {
        return editorToolsImpls[EditorTools.DRAW.ordinal()];
    }
    @Override
    public void onClick(View v) {
        ...
        if (mMissionProxy != null && mMissionProxy.getItems().size() > 0
            ...
            switch (lastMissionItem.getMissionItem().getType()) {
                ...
                case RTL:
                    ...
                    Toast.makeText(getActivity(), getString(R.string.editor_err_land_rtl_added), Toast.LENGTH_SHORT).show();
                    break;
