    ...
    class WidgetsAdapter(context: Context, val fm: FragmentManager) : ArrayAdapter<TowerWidgets>(context, 0, TowerWidgets.values()) {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            viewHolder.prefCheck?.setOnCheckedChangeListener { compoundButton, b ->
                ...
                lbm.sendBroadcast(Intent(SettingMainFragment.ACTION_WIDGET_PREFERENCE_UPDATED)
                        .putExtra(SettingMainFragment.EXTRA_ADD_WIDGET, b)
                        .putExtra(SettingMainFragment.EXTRA_WIDGET_PREF_KEY, towerWidget.prefKey))
            }
