...
import com.dronekit.utils.file.AssetUtil;
...
public class VehicleProfileReader {
    ...
    public static VehicleProfile load(Context context, FirmwareType vehicleType) {
        ...
        try {
            ...
            File file = new File(DirectoryPath.getPublicDataPath() + path);
            if (file.exists()) {
    ...
    private static void loadProfileFromFile(final VehicleProfile newProfile, final File file) throws XmlPullParserException, IOException {
        final InputStream inputStream = new FileInputStream(file);
        VehicleProfileReader.open(inputStream, newProfile);
    }

    private static void loadProfileFromResources(Context context, final String fileName, final String path, final VehicleProfile newProfile) throws IOException, XmlPullParserException {
