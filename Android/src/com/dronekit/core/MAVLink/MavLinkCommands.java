...
import com.MAVLink.enums.MOTOR_TEST_THROTTLE_TYPE;
...
public class MavLinkCommands {
    ...
    public static void changeMissionSpeed(Drone drone, float speed, ICommandListener listener) {
    ...
    public static void setVelocityInLocalFrame(Drone drone, float xVel, float yVel, float zVel, ICommandListener listener) {
    ...
    public static void setConditionYaw(Drone drone, float targetAngle, float yawRate, boolean isClockwise,
     ...
     */
    public static void sendManualControl(Drone drone, short x, short y, short z, short r, int buttons, ICommandListener listener) {
    ...
    public static void sendNavLand(Drone drone, ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();
    ...
    public static void sendNavRTL(Drone drone, ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();
    ...
    public static void sendPause(Drone drone, ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();
    ...
    public static void startMission(Drone drone, ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();
    ...
    public static void sendMotorTestMessage(Drone drone, int motor_num,  int throttle, int duration,ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();

        msg.command = MAV_CMD.MAV_CMD_DO_MOTOR_TEST;
        msg.param1 = motor_num;
        msg.param2 = MOTOR_TEST_THROTTLE_TYPE.MOTOR_TEST_THROTTLE_PERCENT;
        msg.param3 = throttle;
        msg.param4 = duration;
        msg.param5 = 0;
        msg.param6 = 0;
    ...
    public static void sendFlightTermination(Drone drone, ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();
