...
public class MavLinkStreamRates {
    ...
    public static void setupStreamRates(DataLinkProvider MAVClient, byte sysid, byte compid,
        ...
        requestMavlinkDataStream(MAVClient, sysid, compid, MAV_DATA_STREAM.MAV_DATA_STREAM_EXTENDED_STATUS, extendedStatus);
        ...
        requestMavlinkDataStream(MAVClient, sysid, compid, MAV_DATA_STREAM.MAV_DATA_STREAM_RAW_CONTROLLER, rawControler);
        requestMavlinkDataStream(MAVClient, sysid, compid, MAV_DATA_STREAM.MAV_DATA_STREAM_RC_CHANNELS, rcChannels);
    }

    private static void requestMavlinkDataStream(DataLinkProvider mAVClient, byte sysid, byte compid, int stream_id, int rate) {
