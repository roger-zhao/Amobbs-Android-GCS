...
import com.dronekit.core.drone.DroneInterfaces.OnWaypointManagerListener;
...
public class WaypointManager extends DroneVariable {
    ...
    private void processWaypointToSend(msg_mission_request msg) {
        Logger.i("Write Msg: " + String.valueOf(msg.seq));
        writeIndex = msg.seq;
    ...
    private void processReceivedWaypoint(msg_mission_item msg) {
        // Logger.i("Read Last/Curr: " + String.valueOf(readIndex) + "/" + String.valueOf(msg.seq));
