...
import com.dronekit.core.helpers.coordinates.CoordBounds;
...
public class LineTools {
    ...
    public static LatLong FindLineIntersection(LineLatLong first, LineLatLong second) {
        double denom = ((first.getEnd().getLatitude() - first.getStart().getLatitude()) * (second.getEnd().getLongitude() - second.getStart().getLongitude()))
